...
//const userRoutes = require('./routes/getNotifications');
var setNotificationStatus_routes = require('./routes/setNotificationStatus');
app.use(express.json());
app.use('/api',setNotificationStatus_routes);
...
const MONGO_URI = process.env.MONGO_URI || "mongodb://52.201.91.213:27017/socialN"";
